<h2><a href="https://leetcode.com/problems/minimum-amount-of-time-to-fill-cups/">2335. Minimum Amount of Time to Fill Cups</a></h2><h3>Easy</h3><hr><div><p>You have a water dispenser that can dispense cold, warm, and hot water. Every second, you can either fill up <code>2</code> cups with <strong>different</strong> types of water, or <code>1</code> cup of any type of water.</p>
...
<pre style="position: relative;"><strong>Input:</strong> amount = [1,4,2]
...
<pre style="position: relative;"><strong>Input:</strong> amount = [5,4,4]
...
<pre style="position: relative;"><strong>Input:</strong> amount = [5,0,0]
